...
@include('admin.layout.include.header')
    ...
    <script src="{{url('/admin')}}/assets/js/lib/chart-js/Chart.bundle.js"></script>
    <script src="{{url('/admin')}}/assets/js/dashboard.js"></script>
    <script src="{{url('/admin')}}/assets/js/widgets.js"></script>
    <script src="{{url('/admin')}}/assets/js/lib/vector-map/jquery.vmap.js"></script>
    <script src="{{url('/admin')}}/assets/js/lib/vector-map/jquery.vmap.min.js"></script>
    <script src="{{url('/admin')}}/assets/js/lib/vector-map/jquery.vmap.sampledata.js"></script>
    <script src="{{url('/admin')}}/assets/js/lib/vector-map/country/jquery.vmap.world.js"></script>
    <script>
        ( function ( $ ) {
            "use strict";
